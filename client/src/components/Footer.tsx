        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-header font-bold text-lg bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Electricity & Electromagnetism</span>
            </div>
            <p className="text-sm text-muted-foreground mt-2">Interactive learning for electromagnetism concepts</p>
          </div>
          <div className="flex flex-col items-center md:items-end">
            ...
            <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Electricity & Electromagnetism. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
